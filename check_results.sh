...
echo "<html><head><meta charset=\"UTF-8\"><title>Verifica risultati</title>" >> "$HTML_OUT"
...
echo "<h2>Verifica Corrispondenza Risultati</h2>" >> "$HTML_OUT"
echo "<table>" >> "$HTML_OUT"
echo "<tr><th>File</th><th>Tipo SMT</th><th>Tipo ZMI</th><th>Match</th></tr>" >> "$HTML_OUT"
