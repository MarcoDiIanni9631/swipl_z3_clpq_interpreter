...
new13(A,B,C,D,E,F) :- G>=H+ 1, G=B, H= 0, I=J+K, J=C, K= 1, new7(A,I,D,E,F).
new13(A,B,C,D,E,F) :- G+ 1=<H, G=B, H= 0, I=J+K, J=C, K= 1, new7(A,I,D,E,F).
...
new10(A,B,C,D,E) :- F>=G+ 1, F=A, G= 0, H=E, new11(A,H,C,D,E).
new10(A,B,C,D,E) :- F+ 1=<G, F=A, G= 0, H=E, new11(A,H,C,D,E).
new10(A,B,C,D,E) :- F=G, F=A, G= 0, H=I+J, I=C, J= 1, new5(A,B,H,D,E).
new9(A,B,C,D,E) :- F= 1, G=<H, G= 1, H=B, new13(A,F,B,C,D,E).
new9(A,B,C,D,E) :- F= 0, G>=H+ 1, G= 1, H=B, new13(A,F,B,C,D,E).
