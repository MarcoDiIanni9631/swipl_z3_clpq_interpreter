...
end_query :- 
          constr((A=B&(and(C=D,E=F)&(not(A=B)&(~ (0=<C)&(0=<D&(G=H&(~ (H=0)&(select(A,- 9)=0&select(B,- 9)=0))))))))).
end_query :- 
          constr((A=B&(~ (0=<C)&(D=E&(~ (E=0)&(select(A,- 9)=0& ~ (select(B,- 9)=0))))))).
end_query :- 
          constr((A=B&(not(A=B)&(and(C=D,E=F)&(0=<C&(0=<D&(G=H&(G=0&(~ (H=0)&(select(B,- 9)=0&select(A,- 9)=0)))))))))).
end_query :- 
...
end_query :- 
          constr((A=B&(and(C=D,E=F)&(not(A=B)&(0=<C&(~ (0=<D)&(G=H&(~ (G=0)&(select(A,- 9)=0&select(B,- 9)=0))))))))).
end_query :- 
          constr((A=B&(not(A=B)&(and(C=D,E=F)&(0=<C&(0=<D&(G=H&(~ (G=0)&(H=0&(select(B,- 9)=0&select(A,- 9)=0)))))))))).
end_query :- 
          constr((A=B&(0=<C&(D=0&(E=D&(~ (E=0)&(select(A,- 9)=0& ~ (select(B,- 9)=0)))))))).
...
end_query :- 
          constr((A=B&(C=D&(~ (C=0)&(D=0&(~ (select(B,- 9)=0)& ~ (select(A,- 9)=0))))))).
end_query :- 
          constr((A=B&(not(A=B)&(and(C=D,E=F)&(~ (0=<C)&(~ (0=<D)&(G=H&(select(B,- 9)=0&(select(A,- 9)=0& ~ (E=F)))))))))).
end_query :- 
...
inv_main_0(A,B,C,D) :- 
          constr((E=F&(not(E=F)&(and(G=H,B=D)&(0=<G&(0=<H&(A=C&(~ (A=0)&(~ (C=0)&(select(F,- 9)=0&select(E,- 9)=0)))))))))).
inv_main_0(A,B,C,D) :- 
...
end_query :- inv_main_0(A,B,C,D), 
          constr((E=not(ite(0=<F,select(B,- 9),- 1)=ite(0=<G,select(D,- 9),- 1))&(H=not(select(B,- 9)+A=select(D,- 9)+C)&(0=<A&(or(not(I=J),E)&(or(and(F=G,I=J),H,not(B=D))&not(A=<0))))))).
end_query :- inv_main_0(A,B,C,D), 
          constr((E=not(ite(0=<F,select(B,- 9),- 1)=ite(0=<G,select(D,- 9),- 1))&(H=not(select(B,- 9)+A=select(D,- 9)+C)&(A=<0&(or(not(I=J),E)&or(and(F=G,I=J),H,not(B=D))))))).
