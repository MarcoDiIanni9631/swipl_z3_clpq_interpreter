...
new5(A,B,C,D,E) :- F=G, F=A, G= 4, H= -10, I=J+K, J=A, K= 1, new3(I,B,C,H,E).
new5(A,B,C,D,E) :- F>=G+ 1, F=A, G= 4, H=I+J, I=A, J= 1, new3(H,B,C,D,E).
new5(A,B,C,D,E) :- F+ 1=<G, F=A, G= 4, H=I+J, I=A, J= 1, new3(H,B,C,D,E).
new4(A,B,C,D,E) :- F=<G, F=A, G=B, H=I+J, I=D, J= 2, new5(A,B,C,H,E).
