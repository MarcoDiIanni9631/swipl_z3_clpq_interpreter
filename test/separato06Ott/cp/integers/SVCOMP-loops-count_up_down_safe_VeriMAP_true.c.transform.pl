...
new5(A,B,C,D) :- E= 1, F=G, F=D, D>= 0, G=A, A>= 0, new6(E,A,B,C,D).
new5(A,B,C,D) :- E= 0, F>=G+ 1, F=D, D>= 0, G=A, A>= 0, new6(E,A,B,C,D).
new5(A,B,C,D) :- E= 0, F+ 1=<G, F=D, D>= 0, G=A, A>= 0, new6(E,A,B,C,D).
