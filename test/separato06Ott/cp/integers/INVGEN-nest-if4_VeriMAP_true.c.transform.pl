...
new12(A,B,C,D,E) :- F= 1, G=<H, G= 1, H=B, new13(A,F,B,C,D,E).
new12(A,B,C,D,E) :- F= 0, G>=H+ 1, G= 1, H=B, new13(A,F,B,C,D,E).
new11(A,B,C,D,E) :- F+ 1=<G, F=B, G=D, new12(A,B,C,D,E).
new11(A,B,C,D,E) :- F>=G, F=B, G=D, H=E, new9(A,H,C,D,E).
new10(A,B,C,D,E) :- F+ 1=<G, F=B, G=D, H=I+J, I=B, J= 1, new9(A,H,C,D,E).
new10(A,B,C,D,E) :- F>=G, F=B, G=D, H=I+J, I=C, J= 1, new5(A,B,H,D,E).
new9(A,B,C,D,E) :- new10(A,B,C,D,E).
new8(A,B,C,D,E) :- new11(A,B,C,D,E).
