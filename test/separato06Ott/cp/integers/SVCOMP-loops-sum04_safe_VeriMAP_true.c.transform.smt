...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) )
    (=>
      (and (= B 0) (= D 0) (= E 0) (= F 1) (new5 A B F))
      (new6 A B C)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) )
    (=>
      (and (= B 16) (= D 16) (= E 16) (= F 1) (new5 A B F))
      (new4 A B C)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) )
    (=>
      (and (= D 8) (= E (+ 2 B)) (= F 2) (= G (+ 1 A)) (= H 1) (<= A 8) (new2 G E C))
      (new3 A B C)
    )
  )
)
