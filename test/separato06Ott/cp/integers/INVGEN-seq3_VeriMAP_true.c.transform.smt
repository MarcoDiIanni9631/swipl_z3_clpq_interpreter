...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) )
    (=>
      (and (= I 0) (= J (+ 1 H)) (= K 1) (= L (+ (- 1) E)) (= M 1) (>= A 1) (new8 B C D L F G J))
      (new11 A B C D E F G H)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) )
    (=>
      (and (= H 1) (= I 0) (>= D 1) (new11 H A B C D E F G))
      (new10 A B C D E F G)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) )
    (=>
      (and (= H 0) (= I 0) (<= D 0) (new11 H A B C D E F G))
      (new10 A B C D E F G)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) )
    (=>
      (and (= H (+ 1 F)) (= I 1) (= J (+ (- 1) D)) (= K 1) (>= (- B F) 1) (new6 A B C J E H G))
      (new7 A B C D E F G)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) )
    (=>
      (and (= H 0) (>= (- F B) 0) (new8 A B C D E F H))
      (new7 A B C D E F G)
    )
  )
)
