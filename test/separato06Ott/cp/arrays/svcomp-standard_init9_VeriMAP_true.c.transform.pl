new9(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H= 50, I=E, J=K+L, K=E, L= 1, 
          write((B,A),I,H,(M,A)), val(map_N,A), val(a,B), val(ghost(0),C), 
          val(ghost(x),D), val(i,E), val(a,M), val(i,J), new9(A,M,C,D,J).
new9(A,B,C,D,E) :- F>=G, F=E, G=A, H=<I, H= 0, I=D, J+ 1=<K, J=D, K=A, L+ 1=<M, 
          N=O, L=C, P=C, N=D, M= 50, read((B,A),O,P), val(map_N,A), val(a,B), 
          val(ghost(0),C), val(ghost(x),D), val(i,E).
new9(A,B,C,D,E) :- F>=G, F=E, G=A, H=<I, H= 0, I=D, J+ 1=<K, J=D, K=A, L>=M+ 1, 
          N=O, L=C, P=C, N=D, M= 50, read((B,A),O,P), val(map_N,A), val(a,B), 
          val(ghost(0),C), val(ghost(x),D), val(i,E).
new8(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H= 49, I=E, J=K+L, K=E, L= 1, 
          write((B,A),I,H,(M,A)), val(map_N,A), val(a,B), val(ghost(0),C), 
          val(ghost(x),D), val(i,E), val(a,M), val(i,J), new8(A,M,C,D,J).
new8(A,B,C,D,E) :- F>=G, F=E, G=A, H= 0, val(map_N,A), val(a,B), 
          val(ghost(0),C), val(ghost(x),D), val(i,E), val(i,H), new9(A,B,C,D,H).
new7(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H= 48, I=E, J=K+L, K=E, L= 1, 
          write((B,A),I,H,(M,A)), val(map_N,A), val(a,B), val(ghost(0),C), 
          val(ghost(x),D), val(i,E), val(a,M), val(i,J), new7(A,M,C,D,J).
new7(A,B,C,D,E) :- F>=G, F=E, G=A, H= 0, val(map_N,A), val(a,B), 
          val(ghost(0),C), val(ghost(x),D), val(i,E), val(i,H), new8(A,B,C,D,H).
...
%
verimap(pred_smtvars_types([incorrect,new1('Int','(Array Int Int)','Int','Int','Int'),new2('Int','(Array Int Int)','Int','Int','Int'),new3('Int','(Array Int Int)','Int','Int','Int'),new4('Int','(Array Int Int)','Int','Int','Int'),new5('Int','(Array Int Int)','Int','Int','Int'),new6('Int','(Array Int Int)','Int','Int','Int'),new7('Int','(Array Int Int)','Int','Int','Int'),new8('Int','(Array Int Int)','Int','Int','Int'),new9('Int','(Array Int Int)','Int','Int','Int')])).
