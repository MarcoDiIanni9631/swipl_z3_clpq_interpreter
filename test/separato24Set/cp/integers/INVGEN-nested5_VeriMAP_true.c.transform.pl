...
new9(A,B,C,D,E,F) :- G>=H+ 1, G=B, H= 0, I=J+K, J=E, K= 1, new6(A,C,D,I,F).
new9(A,B,C,D,E,F) :- G+ 1=<H, G=B, H= 0, I=J+K, J=E, K= 1, new6(A,C,D,I,F).
new8(A,B,C,D,E) :- F= 1, G>=H, G=D, H=B, new9(A,F,B,C,D,E).
new8(A,B,C,D,E) :- F= 0, G+ 1=<H, G=D, H=B, new9(A,F,B,C,D,E).
