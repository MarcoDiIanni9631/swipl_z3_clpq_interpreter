...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) )
    (=>
      (and (= H 0) (>= E 1) (new20 A B C D E F G))
      (new19 A B C D E F G)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) )
    (=>
      (and (= E 0) (= H 0) (= I 0) (new21 A B C D E F G))
      (new19 A B C D E F G)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) )
    (=>
      (and (= H 0) (>= F 1) (new17 A B C D E F G))
      (new16 A B C D E F G)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) )
    (=>
      (and (= F 0) (= H 0) (= I 0) (new18 A B C D E F G))
      (new16 A B C D E F G)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) )
    (=>
      (and (= H 1) (= I (+ (+ (+ C D) A) B)) (= J 1) (= K (+ (+ D A) B)) (= L (+ A B)) (>= (+ (+ (+ C D) A) B) 1) (new15 H A B C D E F G))
      (new14 A B C D E F G)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) )
    (=>
      (and (= H 0) (= I (+ (+ (+ C D) A) B)) (= J 1) (= K (+ (+ D A) B)) (= L (+ A B)) (<= (+ (+ (+ C D) A) B) 0) (new15 H A B C D E F G))
      (new14 A B C D E F G)
    )
  )
)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) )
    (=>
      (and (= H 1) (= I 0) (>= B 0) (new13 H A B C D E F G))
      (new12 A B C D E F G)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) )
    (=>
      (and (= H 0) (= I 0) (<= B (- 1)) (new13 H A B C D E F G))
      (new12 A B C D E F G)
    )
  )
)
