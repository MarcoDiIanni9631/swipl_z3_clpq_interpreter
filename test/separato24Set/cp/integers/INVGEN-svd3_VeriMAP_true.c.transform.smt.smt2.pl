...
new18(A,B,C,D,E,F,G) :- new9(A,C,D,H,F,G), 
          constr((and(B>=1,and(I=1,and(H=1+E,J=0))))).
new18(A,B,C,D,E,F,G) :- new9(A,C,D,H,F,G), 
          constr((and(B=< - 1,and(I=1,and(H=1+E,J=0))))).
new17(A,B,C,D,E,F) :- new16(A,B,C,D,G,F), constr((and(B-E>=0,and(H=1,G=1+E)))).
new17(A,B,C,D,E,F) :- new14(A,B,C,G,E,F), constr((and(E-B>=1,and(H=1,G=1+D)))).
new16(A,B,C,D,E,F) :- new17(A,B,C,D,E,F), constr((true)).
new15(A,B,C,D,E,F) :- new16(A,B,C,D,F,F), constr((D-B=<0)).
new15(A,B,C,D,E,F) :- new10(A,B,C,F,E,F), constr((D-B>=1)).
new14(A,B,C,D,E,F) :- new15(A,B,C,D,E,F), constr((true)).
new13(A,B,C,D,E,F) :- new18(A,G,B,C,D,E,F), constr((and(D>=1,and(H=1,G=1)))).
new13(A,B,C,D,E,F) :- new18(A,G,B,C,D,E,F), constr((and(D=<0,and(H=1,G=0)))).
new12(A,B,C,D,E,F) :- new13(A,B,C,D,E,F), constr((D-B=<0)).
new12(A,B,C,D,E,F) :- new14(A,B,C,F,E,F), constr((D-B>=1)).
...
new3(A,B,C,D,E,F,G) :- new5(A,C,C,E,F,G), constr((and(B=< - 1,H=0))).
new2(A,B,C,D,E,F) :- new3(A,G,B,C,D,E,F), constr((and(F>=2,and(H=1,G=1)))).
new2(A,B,C,D,E,F) :- new3(A,G,B,C,D,E,F), constr((and(F=<1,and(H=1,G=0)))).
