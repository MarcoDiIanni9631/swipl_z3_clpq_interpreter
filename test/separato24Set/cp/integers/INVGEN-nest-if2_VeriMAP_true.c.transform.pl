new13(A,B,C,D,E) :- F+ 1=<G, F=B, G=D, H=I+J, I=B, J= 1, new8(A,H,C,D,E).
new13(A,B,C,D,E) :- F>=G, F=B, G=D, H=E, new9(A,H,C,D,E).
new12(A,B,C,D,E,F) :- G=H, G=B, H= 0.
new12(A,B,C,D,E,F) :- G>=H+ 1, G=B, H= 0, I=J+K, J=C, K= 1, new9(A,I,D,E,F).
new12(A,B,C,D,E,F) :- G+ 1=<H, G=B, H= 0, I=J+K, J=C, K= 1, new9(A,I,D,E,F).
new11(A,B,C,D,E) :- F= 1, G=<H, G= 1, H=B, new12(A,F,B,C,D,E).
new11(A,B,C,D,E) :- F= 0, G>=H+ 1, G= 1, H=B, new12(A,F,B,C,D,E).
new10(A,B,C,D,E) :- F+ 1=<G, F=B, G=D, new11(A,B,C,D,E).
new10(A,B,C,D,E) :- F>=G, F=B, G=D, H=I+J, I=C, J= 1, new5(A,B,H,D,E).
new9(A,B,C,D,E) :- new10(A,B,C,D,E).
...
new7(A,B,C,D,E) :- F=G, F=A, G= 0, H=E, new9(A,H,C,D,E).
