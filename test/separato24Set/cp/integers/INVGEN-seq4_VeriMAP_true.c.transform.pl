...
new11(A,B,C,D,E,F,G,H) :- I>=J+ 1, I=A, J= 0, K=L+M, L=G, M= 1, N=O-P, O=E, 
          P= 1, new6(B,C,D,N,F,K,H).
new11(A,B,C,D,E,F,G,H) :- I+ 1=<J, I=A, J= 0, K=L+M, L=G, M= 1, N=O-P, O=E, 
          P= 1, new6(B,C,D,N,F,K,H).
new10(A,B,C,D,E,F,G) :- H+ 1=<I, H=G, I=A, J=K+L, K=G, L= 1, M=N-O, N=D, O= 1, 
          new9(A,B,C,M,E,F,J).
new9(A,B,C,D,E,F,G) :- new10(A,B,C,D,E,F,G).
new8(A,B,C,D,E,F,G) :- H= 1, I>=J+ 1, I=D, J= 0, new11(H,A,B,C,D,E,F,G).
new8(A,B,C,D,E,F,G) :- H= 0, I=<J, I=D, J= 0, new11(H,A,B,C,D,E,F,G).
