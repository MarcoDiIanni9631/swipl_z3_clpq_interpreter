...
'main@verifier.error.split' :- 
          constr((and(and(A=false,B=false,or(not(C),D),or(not(C),and(E,C)),or(not(C),not(F)),or(not(G),and(H,G)),I,J,K,or(not(H),L=or(M,N)),or(not(H),O=or(L,P)),or(not(H),and(H,C)),or(not(H),not(O)),or(not(Q),and(Q,G)),or(not(R),and(R,Q)),not(S),R=true,T),and(D=(F=or(not(U=<23),not(U>=0))),and(I=or(not(H),not((0=<U)=M)),and(J=or(not(H),not((0=<V)=N)),and(K=or(not(H),not((W=< - 1)=P)),T=(S=or(not(V=<3),not(V>=0)))))))))), 
