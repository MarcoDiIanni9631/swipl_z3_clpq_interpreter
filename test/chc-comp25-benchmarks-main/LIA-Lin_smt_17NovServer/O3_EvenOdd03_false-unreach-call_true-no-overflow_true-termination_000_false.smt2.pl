...
'main@iseven.exit.split' :- 'main@tailrecurse.i'(A,B), 
          constr((and(or(not(C),and(D,E),and(F,G),and(H,I)),and(or(not(I),and(D,J),and(G,K)),and(or(not(H),not(I),L=1),and(or(not(H),not(I),M=L),and(or(not(H),not(I),N),and(or(not(G),O,not(P)),and(or(not(G),not(Q),not(K)),and(or(not(F),not(G),R=1),and(or(not(F),not(G),M=R),and(or(not(F),not(G),Q),and(or(not(D),not(O),not(P)),and(or(not(D),not(E),S=0),and(or(not(D),not(E),M=S),and(or(not(D),not(T),not(J)),and(or(not(D),T,not(E)),and(or(not(C),U=A mod 2),and(or(not(C),V=(M=U)),and(or(not(C),not(V)),and(or(not(W),and(W,C)),and(or(not(I),X= - 2+B),and(or(not(I),N=(B=2)),and(or(not(H),I),and(or(not(G),Q=(B=0)),and(or(not(G),and(G,P)),and(or(G,not(K)),and(or(not(F),G),and(or(not(D),T=(B=1)),and(or(not(D),and(D,P)),and(or(D,not(J)),and(or(D,not(E)),and(W=true,not((1=<B)=O)))))))))))))))))))))))))))))))))).
