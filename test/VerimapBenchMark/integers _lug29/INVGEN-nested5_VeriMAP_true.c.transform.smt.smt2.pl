...
new9(A,B,C,D,E,F) :- constr((G=0&(H=0&B=0))).
new9(A,B,C,D,E,F) :- new6(A,C,D,G,F), constr((B>=1&(H=1&(G=1+E&I=0)))).
new9(A,B,C,D,E,F) :- new6(A,C,D,G,F), constr((B=< - 1&(H=1&(G=1+E&I=0)))).
new8(A,B,C,D,E) :- new9(A,F,B,C,D,E), constr((D-B>=0&F=1)).
new8(A,B,C,D,E) :- new9(A,F,B,C,D,E), constr((D-B=< - 1&F=0)).
