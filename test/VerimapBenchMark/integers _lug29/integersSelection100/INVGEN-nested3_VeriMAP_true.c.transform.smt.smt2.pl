...
new12(A,B,C,D,E) :- new7(F,C,D,E), constr((A>=1&(G=1&(F=1+B&H=0)))).
new12(A,B,C,D,E) :- new7(F,C,D,E), constr((A=< - 1&(G=1&(F=1+B&H=0)))).
new11(A,B,C,D) :- new10(E,B,C,D), constr((C-A>=1&(F=1&E=1+A))).
new11(A,B,C,D) :- new5(A,E,C,D), constr((A-C>=0&(F=1&E=1+B))).
new10(A,B,C,D) :- new11(A,B,C,D), constr((true)).
new9(A,B,C,D) :- new12(E,A,B,C,D), constr((A>=1&(F=1&E=1))).
new9(A,B,C,D) :- new12(E,A,B,C,D), constr((A=<0&(F=1&E=0))).
