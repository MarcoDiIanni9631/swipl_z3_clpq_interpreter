...
new13(A,B,C,D,E,F) :- new7(A,G,D,E,F), constr((B>=1&(H=1&(G=1+C&I=0)))).
new13(A,B,C,D,E,F) :- new7(A,G,D,E,F), constr((B=< - 1&(H=1&(G=1+C&I=0)))).
...
new10(A,B,C,D,E) :- new11(A,E,C,D,E), constr((A>=1&F=0)).
new10(A,B,C,D,E) :- new11(A,E,C,D,E), constr((A=< - 1&F=0)).
new10(A,B,C,D,E) :- new5(A,B,F,D,E), constr((G=1&(F=1+C&(H=0&(I=0&A=0))))).
new9(A,B,C,D,E) :- new13(A,F,B,C,D,E), constr((B>=1&(G=1&F=1))).
new9(A,B,C,D,E) :- new13(A,F,B,C,D,E), constr((B=<0&(G=1&F=0))).
