...
new12(A,B,C,D,E,F) :- new6(A,C,D,G,F), constr((B>=1&(H=1&(G=1+E&I=0)))).
new12(A,B,C,D,E,F) :- new6(A,C,D,G,F), constr((B=< - 1&(H=1&(G=1+E&I=0)))).
new11(A,B,C,D,E) :- new12(A,F,B,C,D,E), constr((C-B>=0&F=1)).
new11(A,B,C,D,E) :- new12(A,F,B,C,D,E), constr((C-B=< - 1&F=0)).
new10(A,B,C,D,E,F) :- constr((G=0&(H=0&B=0))).
new10(A,B,C,D,E,F) :- new11(A,C,D,E,F), constr((B>=1&G=0)).
new10(A,B,C,D,E,F) :- new11(A,C,D,E,F), constr((B=< - 1&G=0)).
new9(A,B,C,D,E) :- new10(A,F,B,C,D,E), constr((D-C>=0&F=1)).
new9(A,B,C,D,E) :- new10(A,F,B,C,D,E), constr((D-C=< - 1&F=0)).
new8(A,B,C,D,E) :- new9(A,B,C,D,E), constr((A>=1&F=0)).
new8(A,B,C,D,E) :- new9(A,B,C,D,E), constr((A=< - 1&F=0)).
new8(A,B,C,D,E) :- new6(A,B,C,F,E), constr((G=1&(F=1+D&(H=0&(I=0&A=0))))).
new7(A,B,C,D,E) :- new8(A,B,C,D,E), constr((D-E=< - 1)).
new7(A,B,C,D,E) :- new4(A,B,F,D,E), constr((D-E>=0&(G=1&F=1+C))).
new6(A,B,C,D,E) :- new7(A,B,C,D,E), constr((true)).
new5(A,B,C,D,E) :- new6(A,B,C,C,E), constr((E-C>=1)).
new5(A,B,C,D,E) :- new2(A,F,C,D,E), constr((C-E>=0&(G=1&F=1+B))).
