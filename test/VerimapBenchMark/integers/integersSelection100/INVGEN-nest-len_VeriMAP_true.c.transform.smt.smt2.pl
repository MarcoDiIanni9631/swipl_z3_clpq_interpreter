...
new19(A,B,C) :- new18(D,B,C), constr((C-A>=1&(E=1&D=1+A))).
new19(A,B,C) :- new2(A,D,C), constr((A-C>=0&(E=1&D=1+B))).
new18(A,B,C) :- new19(A,B,C), constr((true)).
new17(A,B,C) :- new16(D,B,C), constr((C-A>=1&(E=1&D=1+A))).
new17(A,B,C) :- new18(D,B,C), constr((A-C>=0&D=1)).
new16(A,B,C) :- new17(A,B,C), constr((true)).
new15(A,B,C) :- new14(D,B,C), constr((C-A>=1&(E=1&D=1+A))).
new15(A,B,C) :- new16(D,B,C), constr((A-C>=0&D=1)).
new14(A,B,C) :- new15(A,B,C), constr((true)).
new13(A,B,C) :- new12(D,B,C), constr((C-A>=1&(E=1&D=1+A))).
new13(A,B,C) :- new14(D,B,C), constr((A-C>=0&D=1)).
new12(A,B,C) :- new13(A,B,C), constr((true)).
new11(A,B,C) :- new10(D,B,C), constr((C-A>=1&(E=1&D=1+A))).
new11(A,B,C) :- new12(D,B,C), constr((A-C>=0&D=1)).
new10(A,B,C) :- new11(A,B,C), constr((true)).
new9(A,B,C) :- new8(D,B,C), constr((C-A>=1&(E=1&D=1+A))).
new9(A,B,C) :- new10(D,B,C), constr((A-C>=0&D=1)).
new8(A,B,C) :- new9(A,B,C), constr((true)).
new7(A,B,C) :- new6(D,B,C), constr((C-A>=1&(E=1&D=1+A))).
new7(A,B,C) :- new8(D,B,C), constr((A-C>=0&D=1)).
new6(A,B,C) :- new7(A,B,C), constr((true)).
new5(A,B,C,D) :- constr((E=0&(F=0&A=0))).
new5(A,B,C,D) :- new6(E,C,D), constr((A>=1&(E=1&F=0))).
new5(A,B,C,D) :- new6(E,C,D), constr((A=< - 1&(E=1&F=0))).
new4(A,B,C) :- new5(D,A,B,C), constr((B>=1&(E=1&D=1))).
new4(A,B,C) :- new5(D,A,B,C), constr((B=<0&(E=1&D=0))).
