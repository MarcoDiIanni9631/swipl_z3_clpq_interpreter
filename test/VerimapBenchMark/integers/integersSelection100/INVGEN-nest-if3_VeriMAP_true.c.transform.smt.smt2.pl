...
new11(A,B,C,D,E,F) :- constr((G=0&(H=0&B=0))).
new11(A,B,C,D,E,F) :- new7(A,G,D,E,F), constr((B>=1&(H=1&(G=1+C&I=0)))).
new11(A,B,C,D,E,F) :- new7(A,G,D,E,F), constr((B=< - 1&(H=1&(G=1+C&I=0)))).
...
new9(A,B,C,D,E) :- new11(A,F,B,C,D,E), constr((B>=1&(G=1&F=1))).
new9(A,B,C,D,E) :- new11(A,F,B,C,D,E), constr((B=<0&(G=1&F=0))).
