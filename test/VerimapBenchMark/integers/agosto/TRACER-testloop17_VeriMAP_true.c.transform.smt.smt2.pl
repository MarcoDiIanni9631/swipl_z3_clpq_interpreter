...
new8(A,B,C,D) :- new9(E,A,B,C,D), constr((D=<0&(F=0&E=1))).
new8(A,B,C,D) :- new9(E,A,B,C,D), constr((D>=1&(F=0&E=0))).
new7(A,B,C,D) :- new5(A,E,F,G), 
          constr((B=<0&(H=1&(E=1+B&(I=1&(F=1+C&(G=1&J=1))))))).
new7(A,B,C,D) :- new5(A,E,F,G), 
          constr((B>=1&(H=1&(E=1+B&(I=1&(F=1+C&(G=0&J=1))))))).
...
new3(A,B,C,D,E) :- new5(B,C,D,E), constr((A>=1&F=0)).
new3(A,B,C,D,E) :- new5(B,C,D,E), constr((A=< - 1&F=0)).
new2(A,B,C,D) :- new3(E,A,B,C,D), constr((A>=2&(F=1&E=1))).
new2(A,B,C,D) :- new3(E,A,B,C,D), constr((A=<1&(F=1&E=0))).
new1 :- new2(A,B,C,D), constr((D=0&(C=0&B=0))).
