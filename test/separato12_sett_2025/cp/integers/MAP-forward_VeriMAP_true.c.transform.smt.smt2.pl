...
new9(A,B,C,D,E,F) :- new5(A,G,C,H,I,F), 
          constr((and(F>=1,and(J=1,and(G=1+B,and(K=2,and(I=2+E,and(L=1,and(H=1+D,M=0))))))))).
new9(A,B,C,D,E,F) :- new5(A,G,C,H,I,F), 
          constr((and(F=< - 1,and(J=1,and(G=1+B,and(K=2,and(I=2+E,and(L=1,and(H=1+D,M=0))))))))).
new9(A,B,C,D,E,F) :- new5(A,G,C,H,I,F), 
          constr((and(J=1,and(G=1+B,and(K=1,and(I=1+E,and(L=2,and(H=2+D,and(M=0,and(N=0,F=0)))))))))).
new8(A,B,C,D,E,F) :- constr((and(D+E-3*C>=1,and(G=3,and(H=3*C,I=D+E))))).
new8(A,B,C,D,E,F) :- constr((and(D+E-3*C=< - 1,and(G=3,and(H=3*C,I=D+E))))).
...
new3(A,B,C,D,E,F,G) :- new5(B,H,D,I,J,G), 
          constr((and(A>=1,and(J=0,and(I=0,and(H=0,K=0)))))).
new3(A,B,C,D,E,F,G) :- new5(B,H,D,I,J,G), 
          constr((and(A=< - 1,and(J=0,and(I=0,and(H=0,K=0)))))).
new2(A,B,C,D,E,F) :- new3(G,A,B,C,D,E,F), constr((and(C>=0,and(H=0,G=1)))).
new2(A,B,C,D,E,F) :- new3(G,A,B,C,D,E,F), constr((and(C=< - 1,and(H=0,G=0)))).
