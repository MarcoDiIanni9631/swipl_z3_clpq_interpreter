...
new12(A,B,C,D,E) :- constr((and(F=0,and(G=0,A=0)))).
new12(A,B,C,D,E) :- new7(F,C,D,E), constr((and(A>=1,and(G=1,and(F=1+B,H=0))))).
new12(A,B,C,D,E) :- new7(F,C,D,E), 
          constr((and(A=< - 1,and(G=1,and(F=1+B,H=0))))).
new11(A,B,C,D) :- new10(E,B,C,D), constr((and(C-A>=1,and(F=1,E=1+A)))).
new11(A,B,C,D) :- new5(A,E,C,D), constr((and(A-C>=0,and(F=1,E=1+B)))).
new10(A,B,C,D) :- new11(A,B,C,D), constr((true)).
new9(A,B,C,D) :- new12(E,A,B,C,D), constr((and(A>=1,and(F=1,E=1)))).
new9(A,B,C,D) :- new12(E,A,B,C,D), constr((and(A=<0,and(F=1,E=0)))).
new8(A,B,C,D) :- new9(A,B,C,D), constr((A-C=< - 1)).
new8(A,B,C,D) :- new10(D,B,C,D), constr((A-C>=0)).
...
new3(A,B,C,D,E) :- new5(B,F,D,E), constr((and(A>=1,and(F=1,G=0)))).
new3(A,B,C,D,E) :- new5(B,F,D,E), constr((and(A=< - 1,and(F=1,G=0)))).
new2(A,B,C,D) :- new3(E,A,B,C,D), constr((and(D>=1,and(F=0,E=1)))).
new2(A,B,C,D) :- new3(E,A,B,C,D), constr((and(D=<0,and(F=0,E=0)))).
