...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) )
    (=>
      (and (= D 0) (= E 0) (= F 0) (<= B (- 1)) (new4 F E C))
      (new3 A B C)
    )
  )
)
