new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H>=I, H=J, K=E, I= 0, L=M, L=N, O=E, 
          M= 0, P= 0, Q+ 1=<R, Q=S, T=E, R= 0, U>=V+ 1, U=W, X=E, V= 0, Y= 0, 
...
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H>=I, H=J, K=E, I= 0, L=M, L=N, O=E, 
          M= 0, P= 0, Q+ 1=<R, Q=S, T=E, R= 0, U+ 1=<V, U=W, X=E, V= 0, Y= 0, 
          Z=A1+B1, A1=E, B1= 1, read((B,A),K,J), read((C,A),O,N), 
          read((B,A),T,S), read((C,A),X,W), val(map_N,A), val(a,B), val(b,C), 
          val(f,D), val(i,E), val(f,Y), val(i,Z), new2(A,B,C,Y,Z).
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H>=I, H=J, K=E, I= 0, L=M, L=N, O=E, 
          M= 0, P= 0, Q+ 1=<R, Q=S, T=E, R= 0, U=V, U=W, X=E, V= 0, Y=Z+A1, 
...
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H>=I, H=J, K=E, I= 0, L>=M+ 1, L=N, O=E, 
          M= 0, P+ 1=<Q, P=R, S=E, Q= 0, T>=U+ 1, T=V, W=E, U= 0, X= 0, Y=Z+A1, 
...
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H>=I, H=J, K=E, I= 0, L>=M+ 1, L=N, O=E, 
          M= 0, P+ 1=<Q, P=R, S=E, Q= 0, T+ 1=<U, T=V, W=E, U= 0, X= 0, Y=Z+A1, 
          Z=E, A1= 1, read((B,A),K,J), read((C,A),O,N), read((B,A),S,R), 
          read((C,A),W,V), val(map_N,A), val(a,B), val(b,C), val(f,D), 
          val(i,E), val(f,X), val(i,Y), new2(A,B,C,X,Y).
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H>=I, H=J, K=E, I= 0, L>=M+ 1, L=N, O=E, 
          M= 0, P+ 1=<Q, P=R, S=E, Q= 0, T=U, T=V, W=E, U= 0, X=Y+Z, Y=E, Z= 1, 
          read((B,A),K,J), read((C,A),O,N), read((B,A),S,R), read((C,A),W,V), 
          val(map_N,A), val(a,B), val(b,C), val(f,D), val(i,E), val(i,X), 
          new2(A,B,C,D,X).
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H>=I, H=J, K=E, I= 0, L>=M+ 1, L=N, O=E, 
...
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H+ 1=<I, H=J, K=E, I= 0, L+ 1=<M, L=N, 
          O=E, M= 0, P>=Q+ 1, P=R, S=E, Q= 0, T= 0, U=V+W, V=E, W= 1, 
          read((B,A),K,J), read((B,A),O,N), read((C,A),S,R), val(map_N,A), 
          val(a,B), val(b,C), val(f,D), val(i,E), val(f,T), val(i,U), 
          new2(A,B,C,T,U).
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H+ 1=<I, H=J, K=E, I= 0, L+ 1=<M, L=N, 
          O=E, M= 0, P+ 1=<Q, P=R, S=E, Q= 0, T= 0, U=V+W, V=E, W= 1, 
          read((B,A),K,J), read((B,A),O,N), read((C,A),S,R), val(map_N,A), 
          val(a,B), val(b,C), val(f,D), val(i,E), val(f,T), val(i,U), 
          new2(A,B,C,T,U).
new2(A,B,C,D,E) :- F+ 1=<G, F=E, G=A, H+ 1=<I, H=J, K=E, I= 0, L+ 1=<M, L=N, 
          O=E, M= 0, P=Q, P=R, S=E, Q= 0, T=U+V, U=E, V= 1, read((B,A),K,J), 
          read((B,A),O,N), read((C,A),S,R), val(map_N,A), val(a,B), val(b,C), 
          val(f,D), val(i,E), val(i,T), new2(A,B,C,D,T).
