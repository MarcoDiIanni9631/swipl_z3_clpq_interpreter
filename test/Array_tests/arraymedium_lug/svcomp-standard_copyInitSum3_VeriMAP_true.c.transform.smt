...
(declare-fun new4 ( Int (Array Int Int) (Array Int Int) Int Int Int ) Bool)

(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L (Array Int Int)) )
    (=>
      (and (= G (- H I)) (= J (+ 1 F)) (= K 1) (>= (- A F) 1) (= (select C F) H) (= (select B F) I) (= (store C F G ) L) (new4 A B L D E J))
      (new4 A B C D E F)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G Int) )
    (=>
      (and (= G 0) (>= E 0) (>= (- F A) 0) (>= (- A E) 1) (>= (- E D) 1) (= (select C E) D))
      (new4 A B C D E F)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G Int) )
    (=>
      (and (= G 0) (<= (- E D) (- 1)) (>= E 0) (>= (- F A) 0) (>= (- A E) 1) (= (select C E) D))
      (new4 A B C D E F)
    )
  )
)
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G Int) )
    (=>
      (and (= G 0) (>= (- F A) 0) (new4 A B C D E G))
      (new3 A B C D E F)
    )
  )
)
