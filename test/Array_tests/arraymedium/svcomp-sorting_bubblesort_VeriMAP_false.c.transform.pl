...
new2(A,B,C,D,E,F,G,H,I,J) :- K+ 1=<L, K=H, L=A, M=N-O, N=H, O= 1, P+ 1=<Q, P=R, 
          S=M, Q=T, U=H, V=W, X=H, Y=Z, A1=M, B1=H, C1=V, D1=M, E1= 1, 
...
new2(A,B,C,D,E,F,G,H,I,J) :- K+ 1=<L, K=H, L=A, M=N-O, N=H, O= 1, P>=Q, P=R, 
          S=M, Q=T, U=H, V=W+X, W=H, X= 1, read((B,A),S,R), read((B,A),U,T), 
