...
VERIMAP_DIR = os.environ.get("VERIMAP_DIR")
SMT2MAP_SCRIPT_DIR = os.environ.get("SMT2MAP_SCRIPT_DIR")

if not VERIMAP_DIR or not SMT2MAP_SCRIPT_DIR:
    print("[ERRORE] Devi impostare le variabili d'ambiente VERIMAP_DIR e SMT2MAP_SCRIPT_DIR")
    sys.exit(1)
